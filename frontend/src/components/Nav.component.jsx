...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="nav_top">
          ...
          <div className="nav_items">
            ...
            <NavLink
              to="/search"
              className="tooltip"
              data-tooltip-content="Search Page"
            >
            ...
            <NavLink
              to="/profile"
              className="tooltip"
              data-tooltip-content="History page"
            >
      ...
      <CreatePostModal showCreatePostModal={showCreatePostModal} closeCreatePostModal={closeCreatePostModal}/>
    </>
  );
};
